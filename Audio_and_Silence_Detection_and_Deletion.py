...
class AudioProcessor: 
    ...
    def split_audio_by_silence(self, min_silence_len, threshold): 
        return detect_nonsilent(self.audio, min_silence_len=min_silence_len, 
    ...
    def process_audio(self, min_silence_len=100, threshold=-30, output_folder='output'): 
        try: 
            ...
            output_silent_path = os.path.join(output_folder, 'silent.mp3') 
            output_non_silent_path = os.path.join(output_folder, 'non_silent.mp3') 
...
def main(): 
    ...
    audio_processor.process_audio(min_silence_len=100, threshold=-60, 
